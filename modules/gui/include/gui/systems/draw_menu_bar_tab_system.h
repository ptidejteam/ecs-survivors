...
namespace gui::systems {
    inline void draw_menu_bar_tab_system(flecs::iter &it, size_t i, MenuBarTab &tab, MenuBar &bar, Rectangle &rect) {
        Rectangle rec = {
            rect.width - (float) (i + 1) * bar.item_width, 0, (float) bar.item_width, (float) 25
        };
